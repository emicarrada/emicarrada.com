...
/**
 * Script para probar el newsletter personalizado
 */
...
async function testCustomNewsletter() {
  console.log('🧪 Probando Newsletter Personalizado...\n');
...
emicarrada`;
  ...
  console.log('📤 Enviando newsletter personalizado...\n');
  console.log('📧 Asunto:', testData.subject);
  console.log('🖼️  Imagen:', testData.imageUrl);
  console.log('📬 Destinatario de prueba:', testData.testEmail);
  console.log('\n⏳ Procesando...\n');
